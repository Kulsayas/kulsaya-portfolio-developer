export const projectContent = [
  {
    id: 1,
    name: "Online Game Ecommerce Project",
  ...
  {
    id: 2,
    name: "Admin creates/deletes Employee.",
    img: "/assets/Images/adminCover.png",
    paragaph:
      "Admin to create or delete employee records, in both the User and Admin interfaces. This guarantees that employee data displayed in both sectors remains consistent and up-to-date.",
